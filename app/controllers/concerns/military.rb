module Military
    ...
    def military
        ...
        words9 = [ ".556", ".762", "21-gun salute", "9-line", "9mm", "AAFES", "Abrams", "about-face", 
                    ...
                    "detachment", "detail", "dining facility", "dip", "division", "divorce", "dog tags", 
                    "do not walk on the damn grass", "door gunner", "double time",
                    ...
                    "face paint", "family separation pay", "fast movers", "fat boy program", "fighter pilot", "fire for effect", "fire support", "firing pin", 
                    ...
                    "gas gas gas", "gas mask", "gate guards", "general", "get your hands out of your pockets", 
                    ...
                    "mortars", "motorcade", "motor pool", "mounted", "Motrin", "movement to contact", "MRE", "mustache", "mustard gas", "MWR",
                    "NATO", "Navy", "Navy SEAL", "NCO", "negligent discharge", "non-judicial punishment", "nonner", "NVGs",
                    "observation point", "obstacle course", "officer", "opfor", "opsec", "ordinance", "out of regs", "outside the wire", "pace count", "parachute", 
                    ...
                    "spotter", "squad", "squad leader", "squadron", "Stars and Stripes", "stripes", "strippers", 
