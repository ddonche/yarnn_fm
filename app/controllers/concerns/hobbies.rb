module Hobbies
    ...
    def hobbies
        ...
        school_words = [
            ...
            "Babcock University (NG)", "Babson College (US)", "Bacone College (US)", "Badr University in Cairo (EG)", "Baker College (US)", "Baker University (US)", "Baldwin Wallace University (US)", "Ball State University (US)", "Bangalore University (IN)", "Bangkok University (TH)", "Baptist Bible College (US)", "Barclay College (US)", "Bard College (US)", "Barnard College (US)", "Barton College (US)", "Baylor University (US)", "Beirut Arab University (LB)", "Bellevue College (US)", "Belmont University (US)", "Benjamin Franklin Institute of Technology (US)", "Bennington College (US)", "Berkeley College (US)", "Bethesda University (US)", "Boston College (US)", 
