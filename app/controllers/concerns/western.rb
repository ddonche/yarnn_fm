module Western
    ...
    def western
        words = [ 
          ...
          "boots", "booze", "bounty", "bourbon", "Bowie knife", "brambles", "brand", "branding", "branding iron", 
          ...
          "covered wagon", "cow", 
          "cowboy", "cow patty", "creek", "cross", "cud", 
          ...
          "gussied up", "gut",
          "hang him high",
          "hanging", "hangman", "hat", "hay", "hay bales", "headdress", "heaven", "heifer", "hell", "henhouse", "Henry rifle", "herd",  
          ...
          "thornbush", "then his horse threw a shoe", "thunderclouds", "tobacco", "tombstone", "tracked em all the way to Kansas",
