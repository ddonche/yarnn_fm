module Names
  ...
  def names
    ...
    female_first_names = [ 
      ...
      "Cathy", "Cecilia", 
      "Celeste", "Celine", "Chandra", "Chanel", "Chantel", "Charese", "Charity", "Charlene", 
      ...
      "E.", "Eden", "Edith", "Eleanor", "Elena", "Elise", "Elizabeth", "Eloise", "Elowyn", "Emma", "Emerald", "Emogen", "Esme", 
      "Esmerelda", "Eva", 
    ...
    surnames = [
      ...
      "Black", "Blair", "Blake", "Bleaker", "Blue", "Bond", "Bonds", "Bone", "Bonner", "Boone", 
      "Boot", "Bosch", 
      ...
      "Ham", "Hamilton", "Hamm", "Hammond", "Harden", "Hardy", "Harris", "Harrison", "Hart", "Hatch", "Hatcher", 
      "Hawkins", "Haynes", "Heim", "Heimler", "Hendricks", "Hendrickson", "Herron",
      "Hicks", "Hilton", "Hines", "Hitch", "Hitchcock", "Hitchens", "Holt", "Holter", "Hong", "Horne", "Horner", "Horton", 
      ...
      "Rafferty", "Rakde", "Rake", "Raker", "Ramirez", "Ramos", "Rasmussen", "Red", "Redondo", "Reece", "Reed", 
      "Reese", "Remington", 
      ...
      "Singh", "Smith", "Smithers", "Snell", "Snelty", "Snyder", "Song", "Spencer", "Spoon", "Spooner", "Stand",
