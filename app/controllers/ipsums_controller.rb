class IpsumsController < ApplicationController
  ...
  def fantasy
    ...
    tavern_first = [ "Abandoned", "Able", "Alabaster", "Amber", "Angry", "Anchored", "Ancient", "Arguing", 
      ...
      "Craven", "Crazy", "Crisp", "Crawling", "Crooked", "Crowded", "Cruel", "Crying", "Curly", "Cursed", "Dancing", "Dark", 
      ...
      "Small", "Smelly", "Smoking", "Smoky", "Smooth", "Sneaky", "Snowy", "Soaring", "Soggy", "Sold", "Sorrowful", "Speckled", 
      "Speedy", "Spinning", 
    ...
    tavern_second = [ "Abbot", "Admiral", "Altar", "Amulet", "Anchor", "Angel", "Antler", "Anvil", "Apple", "Apprentice", "Archer", 
      ...
      "Pike", "Pillow", "Pint",
      "Pipe", "Piper", "Piranha", "Plate", "Pocket", "Pod", "Poison", "Pool", "Pond", "Pony", "Porch", "Port", "Porter", "Potion", "Powder", "Priest", 
