class IpsumsController < ApplicationController
  ...
  def fantasy
    ...
    tavern_first = [ "Abandoned", "Able", "Alabaster", "Amber", "Angry", "Anchored", "Ancient", "Arguing", 
      ...
      "Small", "Smelly", "Smoking", "Smoky", "Smooth", "Smug", "Sneaky", "Snowy", "Snug", "Soaring", "Soggy", "Sold", "Sorrowful", "Speckled", 
      "Speedy", "Spinning", 
  ...
  def horror
    capital_words5 = [
      ...
      "Graveyard", "Hearse", "Hell", "Hostel", "Killer", "Lure", "Maggots", 
  ...
  def modern
    ...
    words = [ 
      ...
      "mag", "magazine", "magnum", "mama", "mare", "Marine Corps", "mayonnaise", "McRib", "Memphis", "meth", "Michelob", 
      ...
      "trailer", "train", "Trans-Am", "transmission", "trigger", "trolling", "tuckered", "turkey", "turnip greens", "tweaker", "twine",
  ...
  def ipsum
    ...
    words4 = [
      ...
      "ammunition", "amputation", "antenna", "antibiotics", "armageddon", "armor-piercing", "army",
      ...
      "crows",
      "dagger", "damage", "dead", "death", "destruction", "distilled", "divine retribution", "doctor", "dog", 
      ...
      "starvation", "starving", "stash", "stitch", "storms", "straps", "suture", "SUV",
      "sword", "syringe", 
